...
export default class CoordinatorDashboard extends Component {
    ...
    handleStudentCSVChange = (e) => {
        this.setState((prevState) => (
            {
                ...prevState,
                "student_csv": e.target.files[0],
            }
        ))
    }

    handleGuestCSVChange = (e) => {
        this.setState((prevState) => (
            {
                ...prevState,
                "guest_csv": e.target.files[0],
            }
        ))
    }

    handleStudentCSVUpload = () => {
        const { student_csv } = this.state;
        if (student_csv) {
            const formData = new FormData();
            formData.append('file', student_csv);

            axios.post(apiUrl + 'students/batch/', formData, {
                headers: {
    ...
    handleGuestCSVUpload = () => {
        const { guest_csv } = this.state;
        if (guest_csv) {
            const formData = new FormData();
            formData.append('file', guest_csv);

            axios.post(apiUrl + 'guests/batch/', formData, {
                headers: {
                    'Content-Type': 'multipart/form-data'
                }
            })
                        ...
                        <div className="col-lg-8">
                            <div className="row">
                                ...
                                <div className="col-12">
                                    <div className="card">
                                        <div className="card-body">
                                            <h5 className="card-title">Student Batch Registration</h5>
                                            <div className='mb-3'>
                                                <input type="file" className='form-control' accept='.csv' onChange={this.handleStudentCSVChange} />
                                            </div>
                                            <div className='d-flex flex-row justify-content-between'>
                                                <a className="btn btn-success" href="./docs/student_registration.csv" download="Students.csv">Get Excel</a>
                                                <button className='btn btn-primary' onClick={this.handleStudentCSVUpload}>Upload</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="col-12">
                                    <div className="card">
                                        <div className="card-body">
                                            <h5 className="card-title">Guest Batch Registration</h5>
                                            <div className='mb-3'>
                                                <input type="file" className='form-control' accept='.csv' onChange={this.handleGuestCSVChange} />
                                            </div>
                                            <div className='d-flex flex-row justify-content-between'>
                                                <a className="btn btn-success" href="./docs/guest_registration.csv" download="Guests.csv">Get Excel</a>
                                                <button className='btn btn-primary' onClick={this.handleGuestCSVUpload}>Upload</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
