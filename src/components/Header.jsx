...
export default class Header extends Component {
    ...
    searchSeat = ()=>{
        ...
        seats.forEach((seat)=>{
            if(seat.title.includes(this.state.query) && this.state.query != ""){
    ...
    render() {
        ...
        return (
            <>
                ...
                {
                    ((currentUser.groups.includes('coordinator')) && (
                        <div className="search-bar">
                            <form className="search-form d-flex align-items-center" method="POST" action="./" onSubmit={()=>{return false}}>
                                <input type="text" name="query" placeholder="Search" title="Enter search keyword" value={query} onChange={this.handleQuery}/>
                                <button type="button" title="Search" onClick={this.searchSeat}><i className="bi bi-search"></i></button>
                            </form>
                        </div>
                    ))}
